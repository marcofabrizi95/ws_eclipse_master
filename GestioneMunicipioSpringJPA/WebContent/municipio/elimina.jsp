...
<body>
	...
	<div class="container">
        ...
        <p><a class="btn btn-primary btn-lg" href="EseguiEliminaMunicipioServlet?idInput=<%=municipioInPagina.getId()%>"  role="button">Elimina&raquo;</a></p> <p><a class="btn btn-primary btn-lg" href="home.jsp"  role="button">Vai alla Home &raquo;</a></p>
