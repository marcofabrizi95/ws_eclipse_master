...
<%-- 					<a href="PrepareAnnunciUtenteServlet?idUser=${userInfo.id}"class="btn btn-info">Torna Indietro</a>	 --%>
<!-- 				</div> -->
<!-- 			</div> -->
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<a href="EseguiCompraUtenteServlet?idAnnuncio=${annuncioInPagina.id}"class="btn btn-info">Compra</a>	
				</div>
			</div>
		</div>
		</div>
