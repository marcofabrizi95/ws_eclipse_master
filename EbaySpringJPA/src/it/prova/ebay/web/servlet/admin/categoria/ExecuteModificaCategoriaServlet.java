...
public class ExecuteModificaCategoriaServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Categoria categoriaOLD = categoriaService.get(categoriaDTO.getId());
...
//		}
		...
		categoriaDaInserire.setAnnuncio(categoriaOLD.getAnnuncio());
		
		categoriaService.update(categoriaDaInserire);
