...
@WebServlet("/admin/categoria/PrepareModificaCategoriaServlet")
public class PrepareModificaCategoriaServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		CategoriaDTO categoriaDTO = CategoriaDTO.buildCategoriaDTOInstance(categoriaService.get(idCategoria));
