	...
	<div class="container">
		...
		<form class="form-horizontal" action="ExecuteModificaAbitanteServlet"
			...
			<div class="form-group">
				...
				<c:if test="${messaggioDiErrore.containsKey('eta')}">
						<div class="alert alert-danger" role="alert">
							${messaggioDiErrore.get("eta")}</div>
					</c:if>
				<div class="col-sm-4">
			...
			<div class="form-group">
				...
				<c:if test="${messaggioDiErrore.containsKey('residenza')}">
						<div class="alert alert-danger" role="alert">
							${messaggioDiErrore.get("residenza")}</div>
					</c:if>
				<div class="col-sm-4">
			...
			<div class="form-group">
				...
				<c:if test="${messaggioDiErrore.containsKey('municipio')}">
						<div class="alert alert-danger" role="alert">
							${messaggioDiErrore.get("municipio")}</div>
					</c:if>
				<div class="col-sm-4">
					<input class="form-control" type="text" id="municipioInputId"
						name="municipioInput" value="${abitanteInPagina.municipio.descrizione }">
					<input type="hidden" name="municipioId" id="municipioId" value="${abitanteInPagina.municipio.id }">
				</div>
			</div>
