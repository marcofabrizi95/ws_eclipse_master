...
<title>Dettaglio Persona</title>
</head>
<body>

	<%
		Persona personaInPagina = (Persona) request.getAttribute("personaSingolaAttributeName");
	%>
	...
	<div class="container">
		...
		<div class="container-fluid">
		 ...
		 <a href="EseguiEliminaServlet?idPersona=<%=personaInPagina.getId() %>" class="btn btn-info">SI</a>  <a href="search.jsp" class="btn btn-info">NO</a>
